...
@endrole
@role('Admin')
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('users*','admins*','accountants*','nurses*','lab-technicians*','receptionists*','pharmacists*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('admins*','users*','accountants*','nurses*','lab-technicians*','receptionists*','pharmacists*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('bed-types*','beds*','bed-assigns*','bulk-beds','bed-status')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('bed-status*') ? 'active' : '' }}"
...
@module('Bed Assigns',$modules)
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('bed-types*','beds*','bed-assigns*','bulk-beds','bed-status')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('bed-assigns*') ? 'active' : '' }}"
...
@role('Admin|Receptionist')
@module('Doctors',$modules)
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('doctors*','doctor-departments*','schedules*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('accountants*','admins*','users*','nurses*','lab-technicians*','receptionists*','pharmacists*') ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('nurses*','admins*','users*','accountants*','lab-technicians*','receptionists*','pharmacists*') ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('receptionists*','users*','admins*','accountants*','nurses*','lab-technicians*','pharmacists*') ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('lab-technicians*','admins*','users*','accountants*','nurses*','receptionists*','pharmacists*') ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('pharmacists*','users*','admins*','accountants*','nurses*','lab-technicians*','receptionists*') ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('prescriptions*', 'prescription-medicine-show*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('birth-reports*','death-reports*','investigation-reports*','operation-reports*','employee/patient-diagnosis-test*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('categories*','brands*','medicines*','medicine-purchase*','used-medicine*','medicine-bills*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('categories*','brands*','medicines*','medicine-purchase*','used-medicine*','medicine-bills*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('medicine-bills*') ? 'active' : '' }}" href="{{ route('medicine-bills.index') }}">
...
@endmodule
@endrole
@php($sectionName = (Request::get('section') === null && !Request::is('hospital-schedules') && !Request::is('currency-settings') && !Request::is('operation-categories') && !Request::is('operations')) ? 'general' : Request::get('section'))
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0  {{ (Request::is('settings*', 'currency-settings*', 'hospital-schedules', 'operation-categories*', 'operations*')) ? '' : 'd-none' }}">
...
@role('Doctor')
@module('Doctors',$modules)
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/doctor*','schedules*','doctors*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('employee/doctor*') ? 'active' : '' }}" href="{{ url('employee/doctor') }}">
        {{ __('messages.doctors') }}
    </a>
</li>
...
@endmodule
@module('OPD Patients',$modules)
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('opds*','patient/my-opds*')) ? 'd-none' : '' }}">
