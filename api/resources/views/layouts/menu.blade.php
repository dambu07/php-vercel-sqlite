...
{{--Users--}}
<li class="nav-item {{ Request::is('users*','admins*','accountants*','nurses*','lab-technicians*','receptionists*','pharmacists*') ? 'active' : '' }}">
    <a class="nav-link  d-flex align-items-center py-3"
...
?>
@if ($doctorMGT)
    <li class="nav-item  {{ Request::is('doctors*','doctor-departments*','schedules*') ? 'active' : '' }}">
        <a class="nav-link  d-flex align-items-center py-3"
           href="{{ $doctorMGT }}">
...
@if ($diagnosisMGT)
    <li class="nav-item  {{ Request::is('diagnosis-categories*','patient-diagnosis-test*') ? 'active' : '' }}">
        <a class="nav-link  d-flex align-items-center py-3"
           href="{{ $diagnosisMGT }}">
                                                    <span class="aside-menu-icon me-3"><i
...
{{-- Settings --}}
<li class="nav-item  {{ Request::is('settings*','hospital-schedules*','currency-settings*', 'operation-categories*', 'operations*') ? 'active' : '' }}">
    <a class="nav-link  d-flex align-items-center py-3"
...
@if(Auth::user()->email_verified_at != null)
    ...
    <li class="nav-item  {{ Request::is('employee/doctor*','schedules*','doctors*') ? 'active' : '' }}">
        <a class="nav-link  d-flex align-items-center py-3"
    ...
    ?>
    @if ($reportMgt)
        <li class="nav-item  {{ Request::is('birth-reports*','death-reports*','investigation-reports*','operation-reports*','employee/patient-diagnosis-test*') ? 'active' : '' }}">
            <a class="nav-link  d-flex align-items-center py-3"
            href="{{ $reportMgt }}">
                <span class="aside-menu-icon me-3"><i class="fas fa-file-medical"></i></span>
                <span class="aside-menu-title">{{ __('messages.reports') }}</span>
