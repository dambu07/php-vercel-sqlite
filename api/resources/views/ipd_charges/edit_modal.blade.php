            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 mb-5">
                        ...
                        {{ Form::text('date', null, ['class' => (getLoggedInUser()->thememode ? 'bg-light form-control modelDataPickerzindex' : 'bg-white form-control modelDataPickerzindex'),'id' => 'ipdEditChargeDate','autocomplete' => 'off', 'required']) }}
                    </div>
