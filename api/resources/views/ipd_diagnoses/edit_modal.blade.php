            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('report_type', null, ['class' => 'form-control','required', 'id' => 'editIpdDiagnosisReportType']) }}
                    </div>
                    <div class="form-group col-md-12 mb-5">
                        {{ Form::label('report_date', __('messages.ipd_patient_diagnosis.report_date').':',['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::text('report_date', null, ['class' => (getLoggedInUser()->thememode ? 'bg-light form-control' : 'bg-white form-control'),'id' => 'editIpdDiagnosisReportDate','autocomplete' => 'off', 'required']) }}
                    </div>
                    <div class="form-group col-md-12 mb-5">
                        <div class="form-group">
                            {{ Form::label('description', __('messages.ipd_patient_diagnosis.description').':',['class' => 'form-label']) }}
                            {{ Form::textarea('description', null, ['class' => 'form-control', 'rows' => 4, 'id' => 'editIpdDiagnosisDescription']) }}
                        </div>
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <div class="d-block"></div>
                            <div class="image-picker">
                                <div class="image previewImage" id="editIpdDiagnosisPreviewImage"
                                ...
                                <span class="picker-edit rounded-circle text-gray-500 fs-small" title="Change document">
                                    ...
                                    <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                        {{ Form::file('file',['id'=>'editIpdDiagnosisDocumentImage','class' => 'image-upload d-none','accept' => 'image/*']) }}
                    ...
                    <div class="modal-footer p-0">
                        ...
                        <button type="button" aria-label="Close" id="cancelEditIpdDiagnosis"
