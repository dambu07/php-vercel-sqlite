<div class="card mb-5 mb-xl-10 p-9">
    ...
    @forelse($ipdTimelines as $ipdTimeline)
        <div class="timeline-container ipdTimelines mt-5">
    ...
    @empty
        <div class="timeline-container ipdTimelines d-flex justify-content-center mt-5">
            <div class="timeline-item timeline-spacer d-flex align-items-center">
