<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('category_id', $data['radiologyCategories'], null, ['class' => 'form-select radiologyCategories', 'required', 'id' => 'radiologyCategories', 'placeholder' => 'Select Category', 'required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('charge_id',[], null, ['class' => 'form-select charge-code','required','disabled','id' => 'chargeCode','placeholder'=>('Select Charge'),'required','data-control'=>'select2']) }}
        </div>
    </div>
