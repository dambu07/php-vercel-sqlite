<div class="row">
    ...
    <div class="col-md-4 col-sm-12">
        <div class="form-group mb-5">
            ...
            {{ Form::select('item_category_id', $itemCategories, $itemStock->item_category_id, ['id' => 'editStockItemCategory','class' => 'form-select stockCategory','required','placeholder' => 'Select Item Category', 'data-control' => 'select2']) }}
        </div>
    </div>
    <div class="col-md-4 col-sm-12">
        <div class="form-group mb-5">
    ...
    <div class="col-md-4 col-sm-12">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {!! Form::text('purchase_price', null, ['id'=>'editStockPurchasePrice','class' => 'form-control','required']) !!}
        </div>
    </div>
    ...
    <div class="d-flex justify-content-end">
        {!! Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary me-2', 'id' => 'editStockSave']) !!}
