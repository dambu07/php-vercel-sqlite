<div id="add_operations_modal" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"
                    id="exampleModalLabel">{{ __('messages.common.new') }} {{ __('messages.operation.operation') }}</h3>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
            </div>
            {{ Form::open(['id'=>'addOperationForm']) }}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group mb-5">
                            ...
                            {{ Form::select('operation_category_id', $operation_categories, null, ['class' => 'form-select','id' => 'operationCategoryId','placeholder'=>'Select Category']) }}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group mb-5">
                            ...
                            <span class="required"></span>
                            {{ Form::text('name', null, ['class' => 'form-control','id' => 'operationName']) }}
                        </div>
                    </div>
                </div>
            </div>
