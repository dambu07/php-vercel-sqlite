        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"
                    id="exampleModalLabel">{{ __('messages.common.edit') }} {{ __('messages.operation.operation') }}</h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group mb-5">
                            ...
                            {{ Form::select('operation_category_id', $operation_categories, null, ['class' => 'form-select','id' => 'editOperationCategoryId','placeholder'=>'Select Category']) }}
