                    ...
                    @if($modules['Admin'] == true)
                        ...
                        <div class="widget">
                            <a href="{{ route('admins.index') }}" class="text-decoration-none">
                                <div class="bg-purple shadow-md rounded-10 p-xxl-10  px-5 py-10 d-flex align-items-center justify-content-between mb-sm-3 mb-2">
                                    <div class="bg-purple-700 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                        <i class="fa-solid fa-lock fs-1-xl text-white"></i>
                                    </div>
                                    <div class="text-end text-white">
                                        <h2 class="fs-1-xxl fw-bolder text-white">{{ $data['admins'] }}</h2>
                                        <h3 class="mb-0 fs-5 fw-light">{{ __('messages.admin') }}</h3>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    @if($modules['Accountants'] == true)
                        ...
                        <div class="widget">
                            <a href="{{ route('accountants.index') }}" class="text-decoration-none">
                                <div class="bg-blue shadow-md rounded-10 p-xxl-10 px-5 py-10 d-flex align-items-center justify-content-between my-sm-3 my-2">
                                    <div class="bg-blue-700 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                        <i class="fa-solid fa-file-invoice-dollar fs-1-xl text-white"></i>
                                    </div>
                                    <div class="text-end text-white">
                                        <h2 class="fs-1-xxl fw-bolder text-white">{{ $data['accountants'] }}</h2>
                                        <h3 class="mb-0 fs-5 fw-light">{{ __('messages.accountants') }}</h3>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    @if($modules['Lab Technicians'] == true)
                        ...
                        <div class="widget">
                            <a href="{{ route('lab-technicians.index') }}" class="text-decoration-none">
                                <div class="bg-pink shadow-md rounded-10 p-xxl-10 px-5 py-10 d-flex align-items-center justify-content-between my-sm-3 my-2">
                                    <div class="bg-pink-700 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                        <i class="fa-solid fa-vial-virus fs-1-xl text-white"></i>
                                    </div>
                                    <div class="text-end text-white">
                                        <h2 class="fs-1-xxl fw-bolder text-white">{{ $data['labTechnicians'] }}</h2>
                                        <h3 class="mb-0 fs-5 fw-light">{{ __('messages.lab_technicians') }}</h3>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    @if($modules['Pharmacists'] == true)
                        ...
                        <div class="widget">
                            <a href="{{ route('pharmacists.index') }}" class="text-decoration-none">
                                <div class="bg-darkgreen shadow-md rounded-10 p-xxl-10 px-5 py-10 d-flex align-items-center justify-content-between my-sm-3 my-2">
                                    <div class="bg-darkgreen-700 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                        <i class="fa-solid fa-prescription fs-1-xl text-white"></i>
                                    </div>
                                    <div class="text-end text-white">
                                        <h2 class="fs-1-xxl fw-bolder text-white">{{ $data['pharmacists'] }}</h2>
                                        <h3 class="mb-0 fs-5 fw-light">{{ __('messages.pharmacists') }}</h3>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    @if($modules['Receptionists'] == true)
                        ...
                        <div class="widget">
                            <a href="{{ route('receptionists.index') }}" class="text-decoration-none">
                                <div class="bg-orange shadow-md rounded-10 p-xxl-10 px-5 py-10 d-flex align-items-center justify-content-between my-sm-3 my-2">
                                    <div class="bg-orange-700 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                        <i class="fa-solid fa-user-tie fs-1-xl text-white"></i>
                                    </div>
                                    <div class="text-end text-white">
                                        <h2 class="fs-1-xxl fw-bolder text-white">{{ $data['receptionists'] }}</h2>
                                        <h3 class="mb-0 fs-5 fw-light">{{ __('messages.receptionists') }}</h3>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            @if(count($data['enquiries']) > 0)
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="text-center text-muted">{{ __('messages.common.created_on') }}</th>
                                    </tr>
                                    </thead>
