    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.success) {
                ...
                document.querySelector('#editIpdTimelineDate').
                    _flatpickr.
                ...
                (result.data.visible_to_person == 1)
                    ...
                    : $('#editIpdTimelineVisibleToPerson').
                        prop('checked', false)
                ...
                success: function (obj) {
                    if (obj.success) {
                        setTimeout(function () {
                            ...
                            $('#overviewIpdTimeline').
                                load(location.href + ' #overviewIpdTimeline')
                        }, 500)
                    }
                    swal({
                        title: $('.deletedVariable').val(),
                        text: $('#ipdTimeline').val() +
