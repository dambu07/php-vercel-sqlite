    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.success) {
                ...
                document.querySelector('#editConsultantAppliedDate').
                    _flatpickr.
                    setDate(moment(result.data.applied_date).format())
                ...
                document.querySelector('#editConsultantInstructionDate').
                    _flatpickr.
                    setDate(moment(result.data.instruction_date).format())
